...
_Technologies:_ Angular, C#, .NET Core, TypeScript, SQL Server, AWS, Git.
...
_Technologies:_ Microsoft .NET Core 2.1, C#, .NET 4.7, ASP.NET MVC, Elastic Search, Ubuntu, Windows Server, MSMQ, Angular 1, Git, AWS DynamoDB, AWS CloudFront, AWS S3, Microsoft SQL Server, Couchbase, Redis.
